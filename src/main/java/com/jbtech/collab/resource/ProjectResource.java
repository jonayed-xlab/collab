...
public class ProjectResource {
    ...
    @GetMapping
    public ApiResponse<List<ProjectResponse>> getAll(@RequestParam (required = false) String name) {
        return ApiResponse.success(
    ...
    public ApiResponse<Void> deleteAssignUser(@PathVariable("projectId") Long projectId,
                                                      @PathVariable("userId") Long userId ) {
        projectService.deleteAssignUser(projectId, userId);
        return ApiResponse.success(null);
    }

    @GetMapping("/{projectId}/assign")
    public ApiResponse<List<User>> getUserByProjectId(@PathVariable("projectId") Long projectId) {
        return ApiResponse.success(
                projectService.getUserByProjectId(projectId)
        );
    }

    @GetMapping("/user/{userId}")
    public ApiResponse<List<ProjectResponse>> getProject(@PathVariable("userId") Long userId) {
        return ApiResponse.success(
