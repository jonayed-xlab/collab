...
public class WorkPackageResource {
    ...
    public ApiResponse<List<WorkPackageResponse>> getWorkPackagesByUser(@PathVariable Long userId) {
        return ApiResponse.success(
    ...
    @GetMapping("/all")
    public ApiResponse<List<WorkPackageResponse>> getWorkPackagesAll() {
        return ApiResponse.success(
                workPackageService.getWorkPackagesAll()
        );
    }
    ...
    public ApiResponse<List<RoadMapResponse>> getRoadmap() {
        return ApiResponse.success(
                workPackageService.getRoadmap()
        );
    }

    @GetMapping("/dashboard/{projectId}")
    public ApiResponse<WorkPackageDashboardResponse> getWorkPackageStats(@PathVariable Long projectId) {
        return ApiResponse.success(
